...
def create_sample_data(config: Settings) -> None:
    ...
    with engine.connect() as conn:
        conn.execute(
            switches.insert(),
            [
                {'name': 'switch1', 'is_active': True, 'is_hidden': False, 'groups': ('group1', 'group2'), 'version': None},
                {'name': 'switch2', 'is_active': True, 'is_hidden': False, 'groups': ('group1',), 'version': None},
                {'name': 'switch3', 'is_active': False, 'is_hidden': False, 'groups': ('group1',), 'version': 4},
                {'id': 4, 'name': 'switch4', 'is_active': True, 'is_hidden': False, 'groups': ('group1', 'group3'), 'version': 4},
                {'id': 5, 'name': 'switch5', 'is_active': True, 'is_hidden': False, 'groups': ('group2',), 'version': 4},
                {'id': 6, 'name': 'switch6', 'is_active': True, 'is_hidden': True, 'groups': ('group2',), 'version': 4},
                {
                    'id': 7,
                    'name': 'switch7',
                    'is_active': True,
